...
df_ %>% 
  summarise(unique(id)) # 23 participants
...
lapse_count <- as.character(droplevels(lapse_count)) # 11 participants available for analysis
...
write_rds(individual_models_rf, here("data", "individual models (sensor data)", "individual_models_rf.rds"))
...
write_rds(individual_models_svm, here("data", "individual models (sensor data)", "individual_models_svm.rds"))
...
write_rds(individual_models_elnet, here("data", "individual models (sensor data)", "individual_models_elnet.rds"))
...
write_rds(individual_models_xgb, here("data", "individual models (sensor data)", "individual_models_xgb.rds"))

# extract model performance metrics ------------------------------

individual_models_rf <- read_rds(here("data", "individual models (sensor data)", "individual_models_rf.rds"))
individual_models_svm <- read_rds(here("data", "individual models (sensor data)", "individual_models_svm.rds"))
individual_models_elnet <- read_rds(here("data", "individual models (sensor data)", "individual_models_elnet.rds"))
individual_models_xgb <- read_rds(here("data", "individual models (sensor data)", "individual_models_xgb.rds"))
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_model_performance_plot_sens.png"))) ggsave(individual_model_performance_plot_sens, 
                                                                                                                        filename = here("outputs", "individual models (sensor data)", "individual_model_performance_plot_sens.png"),
...
individual_best_model_performance_stratified_plot_sens <- comparing_models_sens %>%
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_best_model_performance_stratified_plot_sens.png"))) ggsave(individual_best_model_performance_stratified_plot_sens, 
                                                                                                                                          filename = 
                                                                                                                                            here("outputs", "individual models (sensor data)", "individual_best_model_performance_stratified_plot_sens.png"),
                                                                                                                                          dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_best_model_performance_plot_sens.png"))) ggsave(individual_best_model_performance_plot_sens, 
                                                                                                                               filename = here("outputs", "individual models (sensor data)", "individual_best_model_performance_plot_sens.png"),
                                                                                                                               dpi = 320, height = 8, width = 10)

# compare with group model --------------------------------------------------

group_auc <- read_rds(here("data", "group to individual models (sensor data)", "group_to_individual.rds")) %>%
...
sum(individual_to_group$individual_preferred == TRUE)/11*100
sum(individual_to_group$individual_preferred == FALSE)/11*100

individual_to_group_plot_sens <- individual_to_group %>%
  ggplot() +
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_to_group_plot_sens.png"))) ggsave(individual_to_group_plot_sens, 
                                                                                                                 filename = here("outputs", "individual models (sensor data)", "individual_to_group_plot_sens.png"),
                                                                                                                 dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_vip_by_model_type.png"))) ggsave(individual_vip_by_model_type, 
         filename = here("outputs", "individual models (sensor data)", "individual_vip_by_model_type.png"), 
         dpi = 320, height = 8, width = 10)
...
if(!file.exists(here("outputs", "individual models (sensor data)", "individual_vip_best_performing.png"))) ggsave(individual_vip_best_performing, 
                                                                                                                  filename = here("outputs", "individual models (sensor data)" , "individual_vip_best_performing.png"), 
